...
##########################################Spradsheet2#########################################################
#-----Creat Canvas and Scrollbar for Model2
...
#-----Widgets and Frame(Step1)
frameII_1 = tk.Frame(Full_view2, bg = bg)#Main Frame
...
#-----Creat widgets(Step3)
Title_Label3 = tk.Label(frameII_3, text = "Step3. Plot the Deformation map", font = (Font_W, Size), fg = "#66c18c", bg = bg)
